                    ...
                    CmSampler8x8   **pSampler8x8)
{
    ...
    samplerStateDescr.avs->GainFactor = 44;// B-spec default
    samplerStateDescr.avs->GlobalNoiseEstm = 255;// B-spec default
    samplerStateDescr.avs->StrongEdgeThr = 8;// B-spec default
    samplerStateDescr.avs->WeakEdgeThr = 1;		// B-spec default
    samplerStateDescr.avs->StrongEdgeWght = 7;									// B-spec default
    samplerStateDescr.avs->RegularWght = 2;				// B-spec default
    samplerStateDescr.avs->NonEdgeWght = 1;					// B-spec default
#if __INTEL_MDF > 500
